\Chapter{Wnioski i perspektywy rozwoju}\label{chapter:conclusions}
    \section{Problemy rozwiązania}
        ...
        Przykładowo w sytuacji, w której brakuje sal do języka polskiego, nic nie stoi na przeszkodzie by zajęcia te odbyły się w sali do lekcji matematyki.

        Kolejne ograniczenie dotyczy dostępności nauczycieli, które są definiowane w skali dnia.
        W rzeczywistości dostępności powinny być opisane w skali slotów czasowych.

        Ograniczenia dotyczą również samego procesu generowania planów. 
        Algorytm ewolucyjny, stosowany do alokacji bloków lekcyjnych pomiędzy dniami działa poprawnie, jednak jego heurystyczna natura powoduje, że nie gwarantuje optymalności.
    ...
    \section{Perspektywy rozwoju}
        ...
        Kolejnym istotnym elementem jest zmiana sposobu reprezentacji dostępności nauczycieli. 
        Zamiast ograniczeń na poziomie dni, powinny być one definiowane w skali slotów czasowych.
    ...
    \section{Wnioski}
        ...
        Tworzenie bloków lekcyjnych w istotny sposób zmniejszyło liczbę ograniczeń w problemie harmonogramowania --- zastosowany algorytm zachłanny do generowania bloków lekcyjnych okazał się trafnym wyborem.
        ...
        Wygenerowane wyniki, chociaż mogą wymagać drobnych, ręcznych korekt, mogą stanowić podstawę do ułożenia planu.
