\Chapter{Problem układania planu lekcji i algorytm jego rozwiązania}\label{chapter:algorytm}
    ...
    \begin{itemize}
        ...
        \item \textbf{koncepcja dekompozycji i dobór technik} --- przedstawiam kluczową innowację pracy: podział złożonego problemu na trzy mniejsze, sekwencyjne etapy. Dla każdego z nich uzasadniam wybór najodpowiedniejszej techniki algorytmicznej,
...
\section{Dekompozycja problemu i wybór technik}
    ...
    \begin{figure}[h]
        ...
        \end{tikzpicture}
        \caption{Dekompozycja problemu}\label{fig:dekompozycja_problemu}
    \end{figure}
    ...
    Trzeci etap sprowadza się do problemu harmonogramowania, który jak omówiono wcześniej można przekształcić do postaci opisanej w podrozdziale~\ref{section:jssp}.
...
\section{Algorytm zachłanny}
    ...
    \subsection{Działanie}
        ...
        \subsubsection{Procedura}
            ...
            \begin{itemize}
                \item \textbf{Tworzenie grup wieloklasowych} --- grupowanie wymagań głównych dotyczących tego samego przedmiotu dla różnych klas;\\
                przykładowo język rosyjski dla klasy IIIA, IIIC, IIID.
                \item \textbf{Agregacja bloków} --- łączenie powstałych bloków międzyklasowych z innymi wymaganiami, które mogą odbywać się równolegle;\\
                przykładowo wyżej wspomniany język rozyjski oraz język niemiecki dla klasy IIIA. 
                \item \textbf{Tworzenie bloków pojedynczych} --- formowanie bloków wewnątrz pojedynczych klas;\\
                przykładowo podział wychowania fizycznego na grupy chłopięce i dziewczęce.
                \item \textbf{Tworzenie bloków jednostkowych} --- utworzenie jednoelementowych zbiorów dla pozostałych wymagań, niezgrupowanych w poprzednich fazach;\\
...
\section{Algorytm ewolucyjny}
    ...
    \subsection{Kodowanie i ograniczenia twarde}\label{subsection:kodowanie}
        ...
        \begin{itemize}
            \item suma przypisań $i$-tego bloku lekcyjnego musi być równa $v_i$. Zostało to opisane w warunku~(\ref{eq:specimen_wymaganie_glowne}),
