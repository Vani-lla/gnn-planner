...
\section{Dekompozycja problemu i wybór technik}
    ...
    Na rysunku~\ref{fig:struktura_algorytmu_techniki} przedstawiono strukturę algorytmu z wpisanymi odpowiednimi nazwami technik.
    ...
    \subsection{Problem kombinatoryki}
        \begin{itemize}
            \item Wprowadzenie formalnych oznaczeń
            \item Głębsze uzasadnienie wyboru techniki na przykładzie
            \item Funkcja celu
            \item Jak algorytm osiąga funkcję celu i jak to się ma do oryginalnego problemu
        \end{itemize}

    \subsection{Problem alokacji}
        \begin{itemize}
            \item Formalne oznaczenia
            \item Funkcja celu
            \item Jak to się ma do oryginalnego problemu
        \end{itemize}
...
\section{Algorytm ewolucyjny}
    ...
    \subsection{Przykładowy wynik}
        ...
        Na rysunku~\ref{fig:wyniki_ewolucyjny} przedstawiono wartości funkcji celu dla pięciu niezależnych uruchomień algorytmu genetycznego dla 25 generacji, przy następujących parametrach:
        \begin{itemize}
        ...
        \end{figure}
        Średni czas obliczeń dla pięciu prób wyniósł \textbf{95.88 s}.  
