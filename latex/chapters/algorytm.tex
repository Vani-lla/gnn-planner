\Chapter{Problem układania planu lekcji i algorytm jego rozwiązania}\label{chapter:algorytm}
    ...
    \section{Sformułowanie problemu optymalizacyjnego}
        ...
        \begin{enumerate}
            \item Tworzenie bloków lekcyjnych z ograniczeń głównych zdefiniowanych w~\ref{subsubsection:ograniczenie_glowne}:
            \begin{itemize}
            ...
            \end{itemize}
            \item Przydział bloków lekcyjnych do poszczególnych dni tygodnia.
            \begin{itemize}
            ...
            \end{itemize}
            \item Tworzenie przypisań dla każdego dnia tygodnia osobno.
        \end{enumerate}
