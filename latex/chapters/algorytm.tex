...
\section{Dekompozycja problemu i wybór technik}
    ...
    \begin{figure}[h]
        ...
        \end{tikzpicture}
        \caption{Struktura algorytmu}\label{fig:dekompozycja_problemu}
    \end{figure}
    ...
    \subsection{Problem harmonogramowania}
        ...
        \begin{figure}[ht]
            ...
            \caption{Wizualizacja rozwiązania klasycznego problemu JSSP z wykorzystaniem zmiennych przedziałowych~\cite{googleortoolsjssp}}\label{fig:intervals}
        \end{figure}
