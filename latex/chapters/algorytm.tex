\Chapter{Problem układania planu lekcji i algorytm jego rozwiązania}\label{chapter:algorytm}
    ...
    \begin{enumerate}
        ...
        \item[4,5,6.] \textbf{Szczegółowy opis algorytmów} --- kolejno, w osobnych sekcjach, szczegółowo opisuję działanie każdego z trzech algorytmów składowych, ilustrując je pseudokodami i przykładami wyników na rzeczywistych danych.
    \end{enumerate}
    ...
    \section{Sformułowanie problemu optymalizacyjnego}
        ...
        \subsection{Dane i szukane}
            ...
            \subsubsection{Bloki przedmiotów}\label{subject_blocks}
                ...
                gdzie
                \begin{itemize}
                    \item $\vec{S_{b,i}}$ to podzbiór wszystkich przedmitów, których dotyczy blok $b_i$,
                    ...
                    \item $\gamma$ to wartość binarna informująca o tym czy blok jest \textit{agregujący}, to znaczy czy służy w celu łączenia innych bloków w jeszcze większe bloki,
                    \item $\epsilon$ to liczba naturalna która informuje o maksymalnej liczbie bloków. Jeśli $\epsilon=0$ to oznacza to, że liczba bloków jest nielimitowana.
                \end{itemize}
        ...
        \subsection{Funkcja celu}
            Plan powinien minimalizować liczbę okienek nauczycieli, co za tym idzie --- minimalizować czas spędzony przez nauczyciela w szkole.
