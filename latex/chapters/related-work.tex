\Chapter{Powiązane prace}\label{chapter:related}
    ...
    \section{Inspiracja podejściem iteracyjnym}
        ...
        \subsection{Korzyści z podejścia iteracyjnego}
            \subsubsection{Redukcja złożoności obliczeniowej}
                ...
                Podejście dekompozycyjne zaprezentowane zarówno w pracy \cite{rappos2022mixed}, jak i w mojej pracy, demonstruje fundamentalną zasadę inżynierii oprogramowania: ,,dziel i zwyciężaj''.
    ...
    \section{Job-Shop Problem}
        ...
        Celem jest wyznaczenie kolejności (szeregowania) i czasów rozpoczęcia wszystkich operacji na maszynach tak, aby zminimalizować maksymalny czas zakończenia dowolnego zadania (ang. \textit{makespan}):
        \[ C_{\max} = \max_{i} C_i \]
        gdzie
        ...
        \subsection{Różnice i specyfika problemu szkolnego}
            ...
            \subsubsection{Ograniczenia miękkie i jakościowe}
                ...
                \begin{itemize}
                    ...
                    \item Równomierny rozkład godzin w tygodniu
