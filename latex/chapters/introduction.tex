\Chapter{Wstęp}\label{chapter:introduction}
    ...
    \begin{itemize}
        ...
        Jest to zadanie, wykonywane na podstawie szacowanej liczby uczniów w danym roczniku, które wyznacza szkielet całego planu.
        \item \textbf{Harmonogramowanie} jest drugim i bardziej złożonym etapem. 
        Polega na przypisaniu każdej z zaplanowanych lekcji konkretnego dnia, godziny rozpoczęcia i sali, przy ścisłym respektowaniu wszystkich fizycznych, prawnych i jakościowych ograniczeń.
    ...
    \section{Cel i zakres pracy}
        ...
        \begin{itemize}
            ...
            \item algorytm ewolucyjny do optymalizacji rozkładu godzinowego na przestrzeni tygodnia,
        ...
        \begin{itemize}
            ...
            \item integracja modułu algorytmicznego z aplikacją webową i zapewnienie pełnej funkcjonalności poprzez odpowiedni interfejs programowania aplikacji,
...
\section{Układ pracy}
    Praca dzieli się na sześć zasadniczych rozdziałów, które kolejno przedstawiają stan wiedzy, prezentują autorskie rozwiązanie, opisują jego praktyczną implementację, weryfikują jej skuteczność oraz podsumowują uzyskane rezultaty i wskazują kierunki dalszego rozwoju.
    ...
    Dokładnie omówiłem podejście iteracyjne programowania mieszanego całkowitoliczbowego, które było inspiracją dla architektury aplikacji.
    ...
    Dla każdego z tych etapów opisałem dobór i zasadę działania techniki adekwatnej do danego podproblemu oraz przykładowe wyniki na rzeczywistych danych.
    Pozwoli to na prześledzenie logiki całego procesu generowania planu.
