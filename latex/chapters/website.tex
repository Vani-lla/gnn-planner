...
\section{Specyfikacja wymagań}
    ...
    \subsection{Przypadki użycia}
        ...
        Diagram pomaga połączyć specyfikację wymagań z projektem technicznym, stanowiąc punkt wyjścia do dalszej analizy i implementacji.
        ...
        \begin{table}[h!]
            ...
            \begin{tabular}{|p{0.25\textwidth}|p{0.70\textwidth}|}
                ...
                & Plan wyświetlony z perspektywy wygranej klasy bądź nauczyciela \\ \hline
        ...
        \begin{table}[h!]
            ...
            \begin{tabular}{|p{0.25\textwidth}|p{0.70\textwidth}|}
                ...
                & 2. Użytkownik wybiera konkretny zestaw ogarniczeń \\
        ...
        \begin{table}[h!]
            ...
            \begin{tabular}{|p{0.25\textwidth}|p{0.70\textwidth}|}
                ...
                & Stwórzy nowy zbiór danego zasobu bądź ograniczenia \\ \hline
        ...
        \begin{table}[h!]
            ...
            \begin{tabular}{|p{0.25\textwidth}|p{0.70\textwidth}|}
                ...
                & Nowe ograniczenie/zasów zapisany w bazie danych \\ \hline
    ...
    \subsection{Diagramy sekwencji}
        ...
        Jest ważny ponieważ niepotrzebne zwiększanie komunikacji ponad to co jest minimalnie potrzebne może niepotrzebnie zwiększyć czas oczekiwania użytkownika.
        \begin{figure}[!t]
            \centering
        ...
        Kolejny przypadek warty zamodelowania to przeglądanie planów lekcji.
        Tutaj system powinien oferować maksymalną reksonsywność  --- minimalne czasy oczekiwań.
        Wysyłanie zapytać GET do warstwy serwerowej przy każdej zmianie widoku nie wchodzi w grę.
        Dlatego zdecydowałem się na wykonanie jednego większego requesta do bazy danych przy wybraniu planu lekcji, i następne filtrowanie wynikó już po stronie klienta.
        W ten sposób kosztem małego zwiększenia oczekiwania na początkowe zapytanie osiągamy pełną płynność w późniejszym użytkowaniu.
        \begin{figure}[!t]
            \centering
        ...
        Ostatni przypadek, które jest warty zaprojektowania jest wprowadzanie bądź edycja danych.
        Należy to zaprojektować optymalnie, tak aby warstwa serwerowa otrzymywała możliwie jak najmniej zapytań, a użytkownik otrzymywał komunikaty o potwierdzeniu operacji.
        \begin{figure}[!t]
            \centering
...
\section{Projekt}
    \subsection{Architektura systemu}
        Wybór poprawnej architektury stanowi jedno z pierwszych zadań, które stoi przed projektantem aplikacji.
        Aby zagwarantować możliwość spełnienia wszystkich wymagań oraz umożliwić dalszy, łatwy rozwój rozwiązania, zdecydowałem się na podzielenie aplikacji na 4 oddzielne komponenty:
        \begin{enumerate}
            \item Interfejs użytkownika (\textit{ang.} Graphical User Interface GUI) --- odpowiada za komunikację z użytkownikiem, umożliwiając wygodną obsługę systemu bez konieczności znajomości szczegółów działania jego wewnętrznych mechanizmów.
            \item Warstwę sewerową --- umożliwia sprawną integrację wszystkich komponentów poprzez interfejs programowania aplikacji (\textit{ang.} Application Programming Interface, API).
            \item Bazę danych --- przechowywuje wszystkie zasoby, ograniczenia oraz plany lekcji w ustrukturyzowany sposób.
            \item Moduł optymalizacyjny --- pozwala na generowanie planów lekcji.
        \end{enumerate}
    ...
    \subsection{Projekt interfejsu}
        Projekt interfejsu użytkownika opracowałem z uwzględnieniem wymagań funkcjonalnych oraz heurystyk Nilsena~\cite{nielsenheuristics}.
        ...
        \subsubsection{Podgląd planów lekcji}
            Sekcja podglądu planów lekcji realizuje wymagania dotyczące wieloperspektywicznego wglądu w wygenerowane plany.
            Umożliwia przeglądanie wielu wariantów planów, z możliwością przełączania między widokami:
            \begin{itemize}
        ...
        \subsubsection{Moduły wprowadzania danych}
            ...
            \begin{itemize}
                \item \textbf{Strony zasobów podstawowych} umożliwiają zarządzanie czterema fundamentalnymi zasobami: przedmiotami, nauczycielami, klasami oraz salami.
...
\section{Implementacja}
    \subsection{Wybór narzędzi}
        ...
        \subsubsection{Interfejs webowy}
            ...
            Komponentowa architektura Reacta idealnie odpowiada modularnej strukturze aplikacji do układania planu lekcji, umożliwiając tworzenie reużywalnych elementów takich jak nawigacja.
        ...
        \subsubsection{Baza danych}
            ...
            Kluczowym czynnikiem była kompatybilność z biblioteką django-tenants, która umożliwia przyszłą implementację architektury opisanej w dokumentacji~\cite{djangotenants}.
    ...
    \subsection{Implementacja bazy danych w Django}
        ...
        Relacje wiele-do-jednego są definiowanę klasą \verb|ForeignKey(to, on_delete, **options)|, gdzie parametr \verb|on_delete| określa zachowanie przy usuwaniu powiązanych rekordów.
        ...
        Poniżej przedstawiłem przykładową implementację modelu reprezentującego sale.
    ...
    \subsection{Implementacja interfejsu webowego}
        ...
        \subsubsection{Nawigacja}
            ...
            \begin{figure}[H]
                ...
                \caption{Nawigacja interfejsu webowego}
            \end{figure}

        \subsubsection{Strona główna}
            Strona główna pozwala na bezpośrednie przejście do widoku przeglądania planów lekcji, generowania nowych planów, bądź wprowadzania wymagań głównych.
            W widoku klas widać nauczyciela z którym jest lekcja, a w widoku nauczyciela widać klasę.

            \begin{figure}[H]
                \centering
                \includegraphics[width=0.9\textwidth]{images/strona/strona_glowna.png}
                \caption{Strona główna interfejsu webowego}
            \end{figure}
        ...
        \subsubsection{Podgląd planów lekcji}
            ...
            \begin{figure}[H]
                ...
                \caption{Podgląd planu z perspektywy nauczyciela}
            \end{figure}
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.9\textwidth]{images/strona/plan_klasa.png}
                \caption{Podgląd planu z perspektywy klasy}
            \end{figure}
        ...
        \subsubsection{Widok generowania planów lekcji}
            ...
            \begin{figure}[H]
                ...
                \caption{Widok generowania planu lekcji}
            \end{figure}
        ...
        \subsubsection{Widoki wprowadzania zasobów}
            \begin{figure}[H]
                ...
                \caption{Widok dodawania przedmiotów}
            \end{figure}
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.9\textwidth]{images/strona/nauczyciele.png}
                \caption{Widok dodawania nauczycieli}
            \end{figure}
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.9\textwidth]{images/strona/sale.png}
                \caption{Widok dodawania sal}
            \end{figure}
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.9\textwidth]{images/strona/klasy.png}
                \caption{Widok dodawania klas}
            \end{figure}

        \subsubsection{Widok wprowadzania wymagań głównych}
            Widok wprowadzania wymagań głównych, który przypomina arkusz kalkulacyjny pokazany w~\ref{fig:excel_wymagania}.
            Górny wiersz przewija się razem ze stroną.
            ...
            \begin{figure}[H]
                ...
                \caption{Widok dodawania wymagań głównych}
            \end{figure}

        \subsubsection{Widok wprowadzania dostępności nauczycieli}
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.9\textwidth]{images/strona/dostepnosc.png}
                \caption{Widok wprowadzania dostępności nauczycieli}
            \end{figure}

        \subsubsection{Widok wprowadzania bloków przedmiotów}
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.9\textwidth]{images/strona/bloki.png}
                \caption{Widok dodawania bloków przedmiotów}
            \end{figure}
