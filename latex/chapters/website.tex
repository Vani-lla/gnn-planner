...
\section{Implementacja}
    ...
    \subsection{Implementacja bazy danych w Django}
        ...
        Poniżej przedstawiłem przykładowe implementacje wybranych modeli.
...
class Room(models.Model):
    ...
    compatible_subjects = models.ManyToManyField(Subject)
        ...
        \subsubsection{Tabela zbiorów sal}
            \begin{lstlisting}[language=Python]
class RoomPool(models.Model):
    name = models.CharField(max_length=255)
            \end{lstlisting}
        
        \subsubsection{Tabela wymagań głównych}
            \begin{lstlisting}[language=Python]
class Requirement(models.Model):
    req_set = models.ForeignKey(
        RequirementSet, on_delete=models.CASCADE
    )
    teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE)
    group = models.ForeignKey(
        StudentGroup, on_delete=models.CASCADE
    )
