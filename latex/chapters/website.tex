...
\section{Specyfikacja wymagań}
    ...
    \subsection{Wymagania niefunkcjonalne}
        ...
        Szczegółowa specyfikacja wymagań została przedstawiona na rysunku diagramu wymagań \ref{fig:diagram_wymagan}.
    ...
    \subsection{Projekt struktury bazy danych}\label{subsection:projekt_bazy_danych}
        ...
        \begin{table}[p]
            ...
            \begin{tabular}{|p{0.27\textwidth}|p{0.2\textwidth}|p{0.45\textwidth}|}
                ...
                \hline
            \end{tabular}
            \caption{Struktura najważniejszych tabel w bazie danych}
        \end{table}
    \clearpage
...
class RoomPoolViewSet(ModelViewSet):
    ...
    \subsection{Integracja z algorytmem}
        ...
        Dalszy proces jest opisany na diagrame seksencji~\ref{fig:sekwencje_1}
