...
\section{Analiza jakości wyników generowania planu lekcji}
    ...
    \subsection{Omówienie całego planu}
        ...
        Na rysunku~\ref{fig:dydaktyczne_nauczyciele_tygodniowo} przedstawiłem histogram wymaganej tygodniowej liczby godzin lekcyjnych do przeprowadzenia przez nauczycieli.
        ...
        Wielu nauczycielom przypisano tygodniowe obciążenie równe zero.
        ...
        Na rysunkach~\ref{fig:dydaktyczne_nauczyciele_dni} oraz~\ref{fig:dydaktyczne_nauczyciele_klasy} przedstawiłem odpowiednio histogram dziennych obciążeń nauczycieli i klas.
