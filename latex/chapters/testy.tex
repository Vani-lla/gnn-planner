...
\section{Wyniki i analiza skuteczności}
    ...
    Uległy one małym, ale znaczącym zmianom w kontekście układania planu lekcji.
    ...
    \begin{itemize}
        \item Wyjaśnienie dlaczego nie powinno się porównywać wygenerowanego planu 1:1 z planem szkoły
        \item Wyjaśnienie danych wejściowych
        \begin{itemize}
            \item Wyjaśnienie grup religii
            \item Wyjaśnienie klas łączonych
            \item Wyjaśnienei grup językowych
        \end{itemize}
    ...
    \subsection{Porównanie z ręcznie ułożonym planem}
        \begin{itemize}
            \item Konkretne przykłady --- porównanie planów klas łączonych
            \item Pokazanie bloków lekcyjnych row-franc-niem
        \end{itemize}        