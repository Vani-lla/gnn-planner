...
\SetKwIF{Jesli}{Jesliwpp}{Wpp}{Jeśli}{to:}{Jeśli}{W przeciwnym przypadku:}{W przeciwnym przypadku:}
% \SetKwIF{Jesli}{Else}{If}{to}{w przeciwnym razie}{koniec if}
% \SetKw{Return}{zwróć}
\SetKwFor{For}{Dla}{wykonaj:}{}
\SetKwFor{While}{Dopóki}{wykonuj:}{}
\SetKw{Return}{Zwróć}
...
\fancypagestyle{appendixStyle}{
	\fancyhf{}									% wyczyść stopki i nagłówki
	\fancyhead[RO]{								% Prawy, nieparzysty nagłówek
		\hrulefill \hspace{16pt} \large Dodatek
		\put(-443,5.5){%
			\makebox(0,0)[l]{%
				\small Politechnika Wrocławska
			}
	...
	\fancyhead[LE]{								% Lewy, parzysty nagłówek
		\large Dodatek \hspace{16pt} \hrulefill
		\put(-188,5.5){%
			\makebox(0,0)[l]{%
				\small Wydział Informatyki i Telekomunikacji
			}
